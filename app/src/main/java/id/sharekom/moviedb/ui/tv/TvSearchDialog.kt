...
class TvSearchDialog private constructor(context: Context, private val searchQuery: String, private val viewModel: MovieTvViewModel, private val viewLifecycleOwner: LifecycleOwner): Dialog(context), TvSearchAdapter.OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (searchQuery.isEmpty()) {
            ...
            viewModel.getSearchTv(searchQuery).observe(viewLifecycleOwner) { results ->
    ...
    class Builder(private val context: Context) {
        ...
        fun show() = TvSearchDialog(context, searchQuery, viewModel, viewLifecycleOwner).show()
    }
